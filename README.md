...
- **Buy** TRINI with USDC, ETH, or $CHAOSLP. 1% fee goes to the multisig.
- **Sell** TRINI back for any quote asset. 1% of TRINI is burned permanently.
- **Arb** between pools. The USDC pool has a steeper slope (1.5x), making TRINI more expensive there. Arbers buy cheap on ETH/$CHAOSLP and sell expensive on USDC, converging prices and generating fees + burns.
- **Stake** TRINI to earn WETH and $CHAOSLP from pool fees.
...
| Contract | Address |
|----------|---------|
| TRINI Token | [`0x048857035823658872c8BcA4c3C943765e081e85`](https://basescan.org/address/0x048857035823658872c8BcA4c3C943765e081e85) |
...
|------|--------|-------|---------------|-------------|
| TRINI/USDC | 334M | 4.95e-11 (1.5x) | $0.01663 | $2,794,400 |
| TRINI/WETH | 333M | 3.3e-11 (1x) | $0.01109 | $1,863,000 |
| TRINI/$CHAOSLP | 233M | 3.3e-11 (1x) | $0.00779 | $919,100 |

All pools start at ~$0.000025/TRINI. Price increases as supply is purchased.
...
- **Staking**: ChaosLPHub + RewardGauge pattern (stake TRINI, earn WETH + $CHAOSLP)
